...
@section('pageTitle', isset($pageTitle) ? $pageTitle : 'Customer')
...
<div class="container py-5">
  <div class="card glass-card shadow-lg" style="max-width: 550px; margin: auto;">
    
    <div class="text-center mb-4">
      <a href="." class="navbar-brand">
        <img src="{{ asset('images/AuraCare_Logo.png') }}" alt="AuraCare Logo" style="height: 70px;">
      </a>
      <h4 class="fw-bold mt-3 text-dark">Customer Registration</h4>
      <p class="text-muted small">Please fill out the form to create your account</p>
    </div>
